...
class DomainControl:
    ...
    def __init__(self,
        ...
        if numpy.mod(_ndx_preliminary, 2) == 0 and config.annular_transducer:
        ...
        if numpy.mod(_ndy_preliminary, 2) == 0 and config.annular_transducer:
        ...
        if config.annular_transducer and diffraction_type in (PseudoDifferential,
