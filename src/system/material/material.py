...
from simulation.controls.consts import SCALE_FOR_SPATIAL_VARIABLES_Z, \
    SCALE_FOR_PRESSURE, SCALE_FOR_TEMPORAL_VARIABLE
...
class BaseMaterial(IMaterial):
    ...
    def eps_n(self) -> float:
        ...
        scale = SCALE_FOR_SPATIAL_VARIABLES_Z * SCALE_FOR_PRESSURE / SCALE_FOR_TEMPORAL_VARIABLE
